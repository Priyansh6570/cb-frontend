...
window.scrollTo(0, 0);
  ...
  return (
    <main className="mx-auto py-8 px-4">
      <section className="privacy-policy w-[66%] mx-auto md:w-full h-fit p-10 font-[sans-serif] text-justify my-8 bg-white shadow-md">
      <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>
      <p className="text-[#999]">(Last updated: July 10, 2023)</p>
      <p className="mt-4">
      ...
      <h1 className="text-2xl font-bold mt-8">Interpretation and Definitions</h1>
      <h2 className="text-xl font-bold mt-4">Interpretation</h2>
      <p>
      ...
      <ul className="list-disc pl-8 mt-2">
        ...
        <li>
          ...
          this Agreement) refers to RAMDHAN AUTOMOTIVES PRIVATE LIMITED,
          CarsBecho head office Udyog Vihar phase 4 Gurugram, Haryana 122015.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to CarsBecho, accessible from{" "}
          <a
            href="https://carsbecho.com"
      ...
      <h1 className="text-2xl font-bold mt-8">Collecting and Using Your Personal Data</h1>
      <h2 className="text-xl font-bold mt-4">Types of Data Collected</h2>
      ...
      <h3 className="text-lg font-boldmt-4">Usage Data</h3>
      ...
      <h3 className="text-lg font-bold mt-4">Tracking Technologies and Cookies</h3>
      <p>
      ...
      <h2 className="text-xl font-bold mt-8">Use of Your Personal Data</h2>
      ...
      <h2 className="text-lg font-bold mt-8">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-lg font-bold mt-8">Transfer of Your Personal Data</h2>
      <p>
        ...
        data protection laws may differ than those fromYour jurisdiction. Your consent to this Privacy Policy followed by Your submission of such information represents Your agreement to that transfer.

The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.
</p>
<h2 className="text-lg font-bold mt-8">Delete Your Personal Data</h2>
<p>
...
<h2 className="text-lg font-bold mt-8">Disclosure of Your Personal Data</h2>
<h3 className="text-base font-bold mt-4">Business Transactions</h3>
<p>
...
<h3 className="text-base font-bold mt-4">Law enforcement</h3>
<p>
  Under certain circumstances, the Company may be required to disclose
  Your Personal Data if required to do so by law or in response to valid
  requests by public authorities (e.g. a court or a government agency).
</p>
<h3 className="text-base font-bold mt-4">Other legal requirements</h3>
<p>
...
<h2 className="text-lg font-bold mt-8">Security of Your Personal Data</h2>
<p>
...
<h1 className="text-2xl font-bold mt-8">Children's Privacy</h1>
<p>
...
<h1 className="text-2xl font-bold mt-8">Links to Other Websites</h1>
<p>
...
<h1 className="text-2xl font-bold mt-8">Changes to this Privacy Policy</h1>
<p>
...
<ul className="list-disc pl-8 mt-2">
  <li>
    <p>By email: <br /> <a href="mailto:team@carsbecho.com">team@carsbecho.com</a> </p>
  </li>
  <br />
  <li>
    <p className="text-left">
      ...
      <a
        href="https://carsbecho.com/ask-us"
        rel="external nofollow noopener"
        target="_blank"
      >
        https://carsbecho.com/ask-us
      </a>
    </p>
  </li>
</ul>
